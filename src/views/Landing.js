        ...
        <div className="w-[80%] m-auto flex justify-between space-x-8">
          <div>
            <div className="">
              ...
              <div className="flex justify-between text-justify">
                <div className="text-xl font-light">
                  ...
                  apocalyptic events in America. Dr. Ruhling, who has also
                  taught Health Science at Loma Linda University, believes that
                  current events are signaling end-times for America. The book,
                  ”MegaQuake 2023: How 3 Timelines and 7 Events Signal
                  Apocalyptic Times” (White Horse Series Book 2), looks at Bible
                  prophecy and how it relates to what is happening in the world
                  today.
                  <br />
                  <br />
                  Dr. Ruhling writes on current events and predicted war with
                  Iraq before 9/11, based on Daniel’s “vision at the time of the
                  end” in the Bible that includes conflict with the Medes and
                  Persians that are now Iraq and Iran.
                  <Link
                    to="reviews"
                    className="text-xl my-4 text-[#800000] flex"
                  >
            ...
            <div className="">
              ...
              <div className="flex justify-between text-justify">
                <div className="text-xl font-light">
                  Seismologists say the San Andreas is 80 years overdue and
                  could unload anytime. Dr. Richard Ruhling, author on current
                  events and Bible prophecy cites seven events in 2015 that gave
                  us a 7-year warning, like Joseph gave to Pharaoh in Genesis
                  41, and he adds that the US is a lot like Egypt then.
                  <Link
                    to="reviews"
                    className="text-xl my-4 text-[#800000] flex"
                  >
